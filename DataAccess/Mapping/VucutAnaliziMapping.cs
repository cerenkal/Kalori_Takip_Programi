...
{
    public class VucutAnaliziMapping : EntityTypeConfiguration<VucutAnalizi>
    {
        public VucutAnaliziMapping()
        {
            this.HasKey(x => x.ID);
            ...
            this.HasMany(v => v.Kullanicilar)
               .WithRequired(k => k.VucutAnalizi)
